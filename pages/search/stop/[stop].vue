...
onBeforeMount(async () => {
  ...
  const stopRes: { data: Stop[] | null, error: any | null } = await $fetch("/api/get-stop", {
    method: "POST",
  ...
  const serviceTimingRes: { data: ServiceTiming[] | null, error: any | null } = await $fetch("/api/get-services", {
