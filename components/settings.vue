    ...
    >
        <div class="flex justify-between items-center w-[100%]">
            ...
            <button
                ...
                class="rounded-full p-2 bg-bta-elevated-light/10 dark:bg-bta-elevated-dark/10"
            >
                <IconsClose
        ...
        <div class="flex flex-col justify-center items-start gap-4 w-full">
            ...
            <button
                class="self-end rounded-md text-bta-light dark:text-bta-dark p-2 bg-bta-elevated-light/10 dark:bg-bta-elevated-dark/10"
                @click="handleAuth"
            >
                {{ authBtnText }}
            </button>
