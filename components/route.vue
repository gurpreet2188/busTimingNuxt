        ...
        <div class="flex flex-col justify-center items-start gap-4 w-full">
            ...
            >
                ...
                >
                    ...
                    >
                        <span
                            class="absolute rounded-full w-full h-[1.2rem] md:w-[1.5rem] md:h-[1.5rem] top-[0.95rem] bottom-auto md:left-[0.35rem] right-auto bg-bta-loading-bar-light/40 dark:bg-bta-secondary-dark"
                        ></span>
